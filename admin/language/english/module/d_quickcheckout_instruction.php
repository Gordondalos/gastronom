...
<div class="tab-content">
	...
	<div id="in_design" class="tab-pane">
		<div class="tab-body">
			...
			<ol>
				<li>Here you can select a style theme for you checkout. All the themes are CSS files, which are located in catalog/view/theme/gordondalos/stylesheet/d_quickcheckout/theme/</li>
		...
		<div class="tab-body">
			...
			<ol>
				...
				<li>If you want to create a unique style for the whole checkout, use the built-in theme manager. Simply create a file of your theme like so
					...
					<blockquote>
						<p>catalog/view/theme/gordondalos/stylesheet/d_quickcheckout/theme/MYTHEME.css</p>
					</blockquote>
