...
class ControllerModuleDQuickcheckout extends Controller {
    ...
    public function index() {
        ...
        if($this->setting['design']['bootstrap']){
            $this->document->addStyle('catalog/view/theme/gordondalos/stylesheet/d_quickcheckout/bootstrap.css');
        }
        $this->document->addStyle('catalog/view/theme/gordondalos/stylesheet/d_quickcheckout/d_quickcheckout.css');
        $this->document->addStyle('catalog/view/theme/gordondalos/stylesheet/d_quickcheckout/theme/'.$this->setting['design']['theme'].'.css');
